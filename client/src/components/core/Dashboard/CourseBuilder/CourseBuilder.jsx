...
export default function CourseBuilderForm() {
  ...
  return (
    <div className="space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6 overflow-y:auto">
      ...
      <Nest handleChangeEditSectionName={handleChangeEditSectionName} />
